# -*- coding: utf-8 -*-
"""
Created on Wed Apr  1 20:45:34 2020

@author: palan
"""

# python train.py ./MLDS_hw2_1_data/testing_data/feat/ ./MLDS_hw2_1_data/testing_label.json ./output_testset.txt
import os
import sys
import time
import json
...
##################################################################################################################
    ...
    print ('Pickle Generated file content:')
    ...
    test_feat_file = os.listdir(test_feat_folder) #list testing video directory wise
    test_feat_path = [(test_feat_folder + filename) for filename in test_feat_file] #filename with extension
    test_video_IDs = [filename[:-4] for filename in test_feat_file] # remove extenstion form end
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(FLAGS.num_epochs):
            ...
            rd.shuffle(sampled_ID_caption)#shuffle training set
            ...
            print("Average bleu score is " + str(avg))
