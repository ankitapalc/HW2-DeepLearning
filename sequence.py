# build dict #
# python sequence.py ./MLDS_hw2_1_data/training_data/feat/ ./MLDS_hw2_1_data/training_label.json
import sys
...
if __name__ == "__main__":
    ...
    print("shape of caption:", np.shape(ID_caption))
    print("Maximum length of the captions:", max_captions_length)
    print("Average length of the captions:", avg_captions_length)
    print("Number of unique tokens:", num_unique_tokens_captions)
    
    print("ID of first video:", vid_id[0])
    print("Shape of features of first video:", ID_caption[0][0].shape)
    print("Caption of first video:", ID_caption[0][1])
    print("ID of fifth video:", vid_id[4])
    print("Shape of features of fifth video:", ID_caption[4][0].shape)
    print("Caption of fifth video:", ID_caption[4][1])
